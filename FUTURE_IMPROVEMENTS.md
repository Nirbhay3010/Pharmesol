...
- **Call summary card** — auto-generated structured output (who called, what they need, lead score, next steps) ready for CRM
...
- **Failed handoff fallback** — auto-offer callback or priority ticket when escalation target is unavailable
